...
/** */
export default async function UOwnDownloadPage() {
  ...
  // Android
  if (/android/i.test(ua)) redirect(AppInfo.playStoreUrl);
  // iOS
  if (/iPad|iPhone|iPod/i.test(ua)) redirect(AppInfo.appStoreUrl);
